...
<html lang="en">
    <?php 
        ...
        if($_SESSION['role_id'] != 1 and $_SESSION['role_id'] != 2) {
            header("location:".HOME_PAGE);
        } 
    ?>

    <head>
        <title>CSWA - Staff page</title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="container" style="height: 100%;">
                <main class="px-3">
                    <h1 class="h1">Staff page</h1>
                    <h3>This staff page is intended to be accessed by Staff and Admin only.</h3>
                </main>
            </div>
